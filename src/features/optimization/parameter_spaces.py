...
class ParameterSpaces:
    ...
    def get_rsi_space(self, extended: bool = False) -> Tuple[List[Any], List[str]]:
        ...
        if extended:
            ...
            search_space = [
                ...
                Categorical(
                    ["simple", "exponential"], name="rsi_ma_type"
    ...
    def get_xgboost_strategy_space(self) -> Tuple[List[Any], List[str]]:
        ...
        search_space = [
            ...
            Real(
                0.52, 0.8, name="prediction_threshold"
            ...
            Real(
                0.0005, 0.005, name="target_threshold"
            ),  # Minimum return to be considered significant
    ...
    def get_timeframe_specific_spaces(
        self, timeframe: str
    ) -> Tuple[List[Any], List[str]]:
        """
        ...
        search_space = [
            Integer(
                int(base_periods["rsi"] * 0.7),
                int(base_periods["rsi"] * 1.5),
                name="rsi_period",
            ),
            Integer(
                int(base_periods["macd_fast"] * 0.7),
                int(base_periods["macd_fast"] * 1.3),
                name="macd_fast",
            ),
            Integer(
                int(base_periods["macd_slow"] * 0.8),
                int(base_periods["macd_slow"] * 1.3),
                name="macd_slow",
            ),
            Integer(
                int(base_periods["bb"] * 0.7),
                int(base_periods["bb"] * 1.4),
                name="bb_period",
            ),
    ...
    def get_parameter_bounds_summary(self) -> Dict[str, Dict[str, Any]]:
        ...
        return {
            ...
            "bb_period": {
                "min": 10,
                "max": 50,
                "description": "Bollinger Bands MA period",
            },
            "bb_std": {
                "min": 1.5,
                "max": 3.0,
