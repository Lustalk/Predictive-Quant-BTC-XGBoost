...
def test_real_btc_data():
    ...
    try:
        ...
        data_dict = collector.collect_multi_timeframe_data(
            timeframes=timeframes, symbol="BTC/USDT", days_back=days_back
        )
        ...
        for timeframe, data in data_dict.items():
            ...
            print(
                f"   ✅ Data quality: {null_count} nulls, {duplicate_count} duplicates"
            )
...
def main():
    ...
    try:
        ...
        if result["success"]:
            ...
            print(
                f"   Current BTC price: ${result['metrics']['current_btc_price']:,.2f}"
            )
        else:
            print(f"\n⚠️ VALIDATION FAILED")
